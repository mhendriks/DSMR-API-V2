...
Power_Delivered_IDX = 6            	-- Dummy - Usage
Voltage_l1_IDX = 7                 	-- Dummy - Voltage
Current_l1_IDX = 8                	-- Dummy - Amperage
--Voltage_l2_IDX = 9               	-- Dummy - Voltage
--Current_l2_IDX = 10              	-- Dummy - Amperage
--Voltage_l3_IDX = 11             	-- Dummy - Voltage
--Current_l3_IDX = 12           	-- Dummy - Amperage
Power_Delivered_l1_IDX = 9         	-- Dummy = Usage = Electric
--Power_Delivered_l2_IDX = 14       -- Dummy = Usage = Electric
--Power_Delivered_l3_IDX = 15       -- Dummy = Usage = Electric
...
-------------------------------------------------------------------------------------------
Energy_Returned_Tariff1_IDX = 10    -- Dummy = Counter Incremental --> Engergy 
Energy_Returned_Tariff2_IDX = 11    -- Dummy = Counter Incremental --> Engergy
Power_Returned_IDX = 12             -- Dummy - Usage = Electric 
--Power_Returned_l1_IDX =           -- Dummy = Usage = Electric
--Power_Returned_l2_IDX =           -- Dummy = Usage = Electric 
--Power_Returned_l3_IDX =           -- Dummy = Usage = Electric
-------------------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------
  ...
  jsondata:close()
    local jsonCPM = json:decode(jsondevices)
        ...
        Gas_Delivered = jsonCPM.gas_delivered.value * 1000
        Energy_Delivered_Tariff1 = jsonCPM.energy_delivered_tariff1.value * 1000
        Energy_Delivered_Tariff2 = jsonCPM.energy_delivered_tariff2.value * 1000
        Power_Delivered =  jsonCPM.power_delivered.value * 1000
...
--      Current_l3 = jsonCPM.current_l3.value
        Power_Delivered_l1 = jsonCPM.power_delivered_l1.value * 1000
--      Power_Delivered_l2 = jsonCPM.power_delivered_l2.value * 1000
--      Power_Delivered_l3 = jsonCPM.power_delivered_l3.value * 1000
        Energy_Returned_Tariff1 = jsonCPM.energy_returned_tariff1.value * 1000
        Energy_Returned_Tariff2 = jsonCPM.energy_returned_tariff2.value * 1000
        Power_Returned = jsonCPM.power_returned.value * 1000
       	Power_Returned_l1 = jsonCPM.power_returned_l1.value * 1000
--      Power_Returned_l2 = jsonCPM.power_returned_l2.value * 1000
--      Power_Returned_l3 = jsonCPM.power_returned_l3.value * 1000
...
if Debug=="Ja" then
  ...
  print ('Engergie Verbruik T1 (Wh)): ' ..Energy_Delivered_Tariff1.. '')
  print ('Engergie Verbruik T2 (Wh)): ' ..Energy_Delivered_Tariff2..  '')
  print ('Energy Verbruik (W)): ' ..Power_Delivered.. '')
...
-------------------------------------------------------------------------------------------
  ...
  print ('Terug Levering T1 (Wh)): ' ..Energy_Returned_Tariff1.. '')
  print ('Terug Levering T2 (Wh)): ' ..Energy_Returned_Tariff2.. '')
  print ('Actuele Terug Levering (W)): ' ..Power_Returned.. '')
...
commandArray[#commandArray+1] = {['UpdateDevice'] = ''..Energy_Delivered_Tariff1_IDX..'|2|'..Energy_Delivered_Tariff1..''}
commandArray[#commandArray+1] = {['UpdateDevice'] = ''..Energy_Delivered_Tariff2_IDX..'|2|'..Energy_Delivered_Tariff2..''}
